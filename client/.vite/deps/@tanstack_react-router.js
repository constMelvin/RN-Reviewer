...
// node_modules/@tanstack/react-router/dist/esm/useActiveLocation.js
var import_react3 = __toESM(require_react(), 1);
var useActiveLocation = (location) => {
  const router = useRouter();
  const routerLocation = useRouterState({ select: (state) => state.location });
  const [activeLocation, setActiveLocation] = (0, import_react3.useState)(
    routerLocation
  );
  const [customActiveLocation, setCustomActiveLocation] = (0, import_react3.useState)(location);
  ...
  const getFromPath = (0, import_react3.useCallback)(
    (from) => {
...
function HeadContent() {
  const tags = useTags();
  return tags.map((tag) => (0, import_react5.createElement)(Asset, { ...tag, key: `tsr-meta-${JSON.stringify(tag)}` }));
}
...
var Scripts = () => {
  ...
  return (0, import_jsx_runtime15.jsx)(import_jsx_runtime15.Fragment, { children: allScripts.map((asset, i) => (0, import_react6.createElement)(Asset, { ...asset, key: `tsr-scripts-${asset.tag}-${i}` })) });
};
export {
  Asset,
  Await,
