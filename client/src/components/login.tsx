...
const Login = () => {
  ...
  return (
    <div className="h-screen flex items-center justify-center">
      <div className="w-full h-full grid lg:grid-cols-2 p-4 gap-5">
        <div className="mx-auto max-w-md w-full flex flex-col items-center px-20 py-5 rounded-lg bg-yellow-100">
